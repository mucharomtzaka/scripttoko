      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand fa fa-home" href="<?php echo base_url();?>beranda/index">
            <?php echo isset($title) ? $title : ' Mediashop Member ';?></a>
        </div>
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          ...
          <ul class="nav navbar-nav navbar-right navbar-user">
		   ...
		   <li><a href="#peta"><i class="glyphicon glyphicon-flag"></i>Status ORDER </a></li>
		    <li><a href="<?php echo base_url('beranda/payment');?>"><i class="glyphicon glyphicon-flag">
        </i>Konfirmasi Bank Transfer </a></li>
			   <li><a href="<?php echo base_url('welcome/keranjang');?>"><i class="glyphicon glyphicon-shopcart"></i> Keranjang Belanja [<?php echo $total;?>]</a></li>
				<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="glyphicon glyphicon-sign up"></i> Profil User[<?php echo $username;?>]</a>
                  ...
                  <li><a href="<?php echo base_url('');?>"><i class=""></i>Pesanan Saya</a></li>
				  <li><a href="<?php echo base_url('histori/index');?>"><i class=""></i>Histori login</a></li>
                  <li><a href="<?php echo base_url('');?>"><i class=""></i>wishlist</a></li>
                  <li><a href="<?php echo base_url('');?>"><i class=""></i>Pengembalian barang saya</a></li>
